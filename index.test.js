...
describe('tests block', () => {
    ...
    describe('execute testing scenario of auth alert', () => { //Green
        it('should check a validation of input data to auth alert box', async (done) => {           
            ...
            // await driver.alert().sendKeys('admin', Key.TAB)
            // // await driver.sendKeys('admin', Key.TAB)
            // // await driver.sleep(1000)
            // await driver.alert().sendKeys('admin')
    ...
    describe('execute scenario of testing dynamic content', () => { //Green
        it('should dynamically change text after clicking on link', async (done) => {
            ...
            //Проверка не внутри экспекта, а с помощью свойств .toBe... toBeFalsy
            done()      
        }, 10000)
    })
    ...
    describe('execute scenario of testing a download function', () => { //Green without expect
    ...
    describe('execute scenario of testing login & logout functions', () => { //Green
        it('should input a valid username & pass -> check if logged in -> log out -> check if logged out', async (done) => {
    ...
    describe('execute scenario of testing a secured download function', () => { //Green with questions: alert is not handeled/detected
